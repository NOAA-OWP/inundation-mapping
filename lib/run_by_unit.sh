...
$libDir/hydrocond.py -b $outputHucDataDir/flows_grid_boolean.tif -d $outputHucDataDir/dem_meters.tif -p $outputHucDataDir/stream_proximity.tif -sm 10 -sh 1000 -o $outputHucDataDir/dem_burned.tif 
Tcount
##############################################################################
