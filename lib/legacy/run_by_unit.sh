...
$libDir/split_flows.py $outputDataDir/demDerived_reaches.gpkg "$PROJ" $outputDataDir/dem_thalwegCond_filled.tif $outputDataDir/demDerived_reaches_split.gpkg $outputDataDir/demDerived_reaches_split_points.gpkg
Tcount
...
mpiexec -n $ncores_gw $taudemDir/gagewatershed -p $outputDataDir/flowdir_d8_thalwegCond_filled.tif -gw $outputDataDir/gw_catchments_reaches.tif -o $outputDataDir/demDerived_reaches_split_points.gpkg -id $outputDataDir/idFile.txt
Tcount
...
# ## POST PROCESS REACH WATERSHEDS ##
# echo -e $startDiv"Adding Attributes To Reach Watersheds"$stopDiv
# date -u
# Tstart
# [ ! -f $outputDataDir/gw_catchments_reaches_clipped_addedAttributes.gpkg ] && \
# $libDir/add_attributes_to_catchments.py $outputDataDir/gw_catchments_reaches_clipped.gpkg $outputDataDir/demDerived_reaches_split_clipped.gpkg $outputDataDir/gw_catchments_reaches_clipped_addedAttributes.gpkg
# Tcount
...
date -u
Tstart
$libDir/make_stages_and_catchlist.py $outputDataDir/demDerived_reaches_split_clipped.gpkg $outputDataDir/stage.txt $outputDataDir/catchment_list.txt $stage_min $stage_interval $stage_max
Tcount
...
$taudemDir/catchhydrogeo -hand $outputDataDir/rem_clipped_zeroed.tif -catch $outputDataDir/gw_catchments_reaches_clipped.tif -catchlist $outputDataDir/catchment_list.txt -slp $outputDataDir/slopes_d8_thalwegCond_filled_clipped.tif -h $inputDataDir/stage.txt -table $outputDataDir/src_base.csv
Tcount
...
fio cat $outputDataDir/gw_catchments_reaches_clipped.gpkg | rio zonalstats -r $outputDataDir/nwm_catchments_proj_120903.tif --stats majority > $outputDataDir/majority.geojson
Tcount
...
Tstart
[ ! -f $outputDataDir/gw_catchments_reaches_clipped_addedAttributes.gpkg ] && \
$libDir/add_attributes_to_catchments_and_flows.py $outputDataDir/gw_catchments_reaches_clipped.gpkg $outputDataDir/demDerived_reaches_split_clipped.gpkg $outputDataDir/majority.geojson $outputDataDir/gw_catchments_reaches_clipped_addedAttributes.gpkg $outputDataDir/demDerived_reaches_split_clipped_addedAttributes.gpkg
Tcount
