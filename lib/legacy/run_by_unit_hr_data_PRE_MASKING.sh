...
# ogr2ogr -progress -f GPKG -clipsrc $outputDataDir/wbd_projected.gpkg $outputDataDir/flows.gpkg $inputDataDir/RouteLink_FL_2019_05_09.shp
Tcount
...
## CONVERT TO METERS ##
echo -e $startDiv"Convert to DEM to Meters"$stopDiv
date -u
Tstart
...
## PIT REMOVE DEM ##
echo -e $startDiv"Pit remove Thalweg DEM"$stopDiv
date -u
Tstart
...
## D8 FLOW DIR ##
echo -e $startDiv"D8 Flow Directions on Thalweg DEM"$stopDiv
date -u
Tstart
mpiexec -n $ncores_d8 $taudemDir/d8flowdir -fel $outputDataDir/dem_burned_flows_filled.tif -p $outputDataDir/flowdir_d8_flows.tif -sd8 $outputDataDir/slopes_d8_flows.tif \
...
date -u
Tstart
$taudemDir/flowdircond -p $outputDataDir/flowdir_d8_flows.tif -z $outputDataDir/dem_meters.tif -zfdc $outputDataDir/dem_thalwegCond.tif \
...
# $libDir/d8_rem.py $outputDataDir/dem_thalwegCond.tif $outputDataDir/flows_grid_pixels.tif $outputDataDir/gw_catchments_pixels.tif $outputDataDir/rem.tif $ncores\
Tcount
