...
cp -a $inputFlows $outputDataDir/flows.gpkg
# ogr2ogr -t_srs "$PROJ" -f GPKG $outputDataDir/flows.gpkg $inputFlows -where "HUC6 = '120903'"
Tcount
...
cp -a $inputHeadwaters $outputDataDir/headwaters.gpkg
Tcount

## GET CATCHMENTS ##
echo -e $startDiv"Get Catchments"$stopDiv
date -u
Tstart
[ ! -f $outputDataDir/nwm_catchments_proj_120903.gpkg ] && \
cp -a $inputHeadwaters $outputDataDir/
Tcount
...
gdal_rasterize -ot Int32 -l NWMCatchment -a feature_id -a_nodata 0 -init 0 -co "COMPRESS=LZW" -co "BIGTIFF=YES" -co "TILED=YES" -te $xmin $ymin $xmax $ymax -ts $ncols $nrows $inputCatchments $outputDataDir/nwm_catchments_proj_120903.tif
Tcount
...
date -u
Tstart
$taudemDir/aread8 -p $outputDataDir/flowdir_d8_thalwegCond_filled.tif -ad8  $outputDataDir/flowaccum_d8_thalwegCond.tif -wg  $outputDataDir/headwaters.tif -nc
Tcount
...
date -u
Tstart
$taudemDir/threshold -ssa $outputDataDir/flowaccum_d8_thalwegCond.tif -src  $outputDataDir/demDerived_streamPixels.tif -thresh 1
Tcount
...
$taudemDir/streamnet -p $outputDataDir/flowdir_d8_thalwegCond_filled.tif  -fel $outputDataDir/dem_thalwegCond_filled.tif -ad8 $outputDataDir/flowaccum_d8_thalwegCond.tif -src $outputDataDir/demDerived_streamPixels.tif -ord $outputDataDir/streamOrder.tif -tree $outputDataDir/treeFile.txt -coord $outputDataDir/coordFile.txt -w $outputDataDir/sn_catchments_reaches.tif -net $outputDataDir/demDerived_reaches.gpkg
Tcount
...
date -u
Tstart
[ ! -f $outputDataDir/demDerived_reaches_clipped.gpkg ] && \
ogr2ogr -progress -f GPKG -clipsrc $outputDataDir/wbd_projected.gpkg $outputDataDir/demDerived_reaches_clipped.gpkg $outputDataDir/demDerived_reaches.gpkg
Tcount

# ## CLIP DEM THALCOND FILLED ##
# echo -e $startDiv"Clip DEM Thalcond Filled to HUC"$stopDiv
# date -u
# Tstart
# [ ! -f $outputDataDir/dem_thalwegCond_filled_clipped.tif ] && \
# gdalwarp -r bilinear -cutline $outputDataDir/wbd_projected.gpkg -crop_to_cutline -ot Float32 -of "GTiff" -overwrite -co "BLOCKXSIZE=512" -co "BLOCKYSIZE=512" -co "TILED=YES" -co "COMPRESS=LZW" -co "BIGTIFF=YES" $outputDataDir/dem_thalwegCond_filled.tif $outputDataDir/dem_thalwegCond_filled_clipped.tif
# Tcount
...
date -u
Tstart
[ ! -f $outputDataDir/demDerived_reaches_split.gpk ] && \
$libDir/split_flows.py $outputDataDir/demDerived_reaches_clipped.gpkg "$PROJ" $outputDataDir/dem_thalwegCond_filled.tif $outputDataDir/demDerived_reaches_split.gpkg $outputDataDir/demDerived_reaches_split_points.gpkg
Tcount

## CLIP D8 THALCOND FILLED ##
echo -e $startDiv"Clip D8 Thalcond Filled to HUC"$stopDiv
date -u
Tstart
[ ! -f $outputDataDir/flowdir_d8_thalwegCond_filled_clipped.tif ] && \
gdalwarp -r bilinear -cutline $outputDataDir/wbd_projected.gpkg -crop_to_cutline -ot Float32 -of "GTiff" -overwrite -co "BLOCKXSIZE=512" -co "BLOCKYSIZE=512" -co "TILED=YES" -co "COMPRESS=LZW" -co "BIGTIFF=YES" $outputDataDir/flowdir_d8_thalwegCond_filled.tif $outputDataDir/flowdir_d8_thalwegCond_filled_clipped.tif
Tcount
...
mpiexec -n $ncores_gw $taudemDir/gagewatershed -p $outputDataDir/flowdir_d8_thalwegCond_filled_clipped.tif -gw $outputDataDir/gw_catchments_reaches.tif -o $outputDataDir/demDerived_reaches_split_points.gpkg -id $outputDataDir/idFile.txt
Tcount
...
$libDir/reachID_grid_to_vector_points.py $outputDataDir/demDerived_streamPixels.tif $outputDataDir/flows_points_pixels.gpkg featureID
Tcount
...
date -u
Tstart
[ ! -f $outputDataDir/slopes_d8_thalwegCond_filled_clipped.tif ] && \
gdalwarp -r near -cutline $outputDataDir/wbd_projected.gpkg -crop_to_cutline -ot Float32 -of "GTiff" -overwrite -co "BLOCKXSIZE=512" -co "BLOCKYSIZE=512" -co "TILED=YES" -co "COMPRESS=LZW" -co "BIGTIFF=YES" $outputDataDir/slopes_d8_thalwegCond_filled.tif $outputDataDir/slopes_d8_thalwegCond_filled_clipped.tif
Tcount
...
date -u
Tstart
$libDir/make_stages_and_catchlist.py $outputDataDir/demDerived_reaches_split.gpkg $outputDataDir/stage.txt $outputDataDir/catchment_list.txt $stage_min $stage_interval $stage_max
Tcount
...
$taudemDir/catchhydrogeo -hand $outputDataDir/rem_clipped_zeroed.tif -catch $outputDataDir/gw_catchments_reaches.tif -catchlist $outputDataDir/catchment_list.txt -slp $outputDataDir/slopes_d8_thalwegCond_filled_clipped.tif -h $inputDataDir/stage.txt -table $outputDataDir/src_base.csv
Tcount
...
fio cat $outputDataDir/gw_catchments_reaches.gpkg | rio zonalstats -r $outputDataDir/nwm_catchments_proj_120903.tif --stats majority > $outputDataDir/majority.geojson
Tcount
...
date -u
Tstart
[ ! -f $outputDataDir/gw_catchments_reaches_addedAttributes.gpkg ] && \
$libDir/add_attributes_to_catchments_and_flows.py $outputDataDir/gw_catchments_reaches.gpkg $outputDataDir/demDerived_reaches_split.gpkg $outputDataDir/majority.geojson $outputDataDir/gw_catchments_reaches_addedAttributes.gpkg $outputDataDir/demDerived_reaches_split_addedAttributes.gpkg
Tcount
