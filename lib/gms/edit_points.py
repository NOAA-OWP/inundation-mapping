...
def Edit_points(stream_reaches,branch_id_attribute,reach_points,
                out_reach_points=None,out_pixel_points=None,verbose=False):
    ...
    reach_points = reach_points.merge(stream_reaches.loc[:,["HydroID",branch_id_attribute]],how='inner',on='HydroID')
...
if __name__ == '__main__':
    ...
    parser.add_argument('-o','--out-reach-points', help='Output stream network', required=False,default=None)
    parser.add_argument('-p','--out-pixel-points', help='Dissolved output stream network', required=False,default=None)
