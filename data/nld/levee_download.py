...
def download_nld_lines():
    ...
    levee geopackage for use in levee burning. NOTE: In order for the files generated by this script to be used, update the date (today) in bash_variables.env for input_NLD, input_levees_preprocessed, and input_nld_levee_protected_areas.
    '''
