...
def aws_exception_handler(ex):
    ...
    elif ( (isinstance(ex, botocore.exceptions.NoRegionError)) or (
          isinstance(ex, botocore.exceptions.InvalidRegionError)) or (
          isinstance(ex, botocore.exceptions.UnknownRegionError)) ):  # 1003
        msg = "ERROR: AWS No Region Value, Invalid or Unknown Region Defined: An aws region value," \
    ...
    # This can be used to catch more specific errors usuall after the client has been created succssfully
        ...
        if error_code == 'NoSuchBucket':
            ...
            msg = "ERROR: AccessDeniedException: Your authorization to talk to AWS is just fine," \
            ...
            msg = "ERROR: SignatureDoesNotMatch: This generally means the AWS Secret Access key is incorrect." \
            ...
            msg = "ERROR: Undefined AWS ClientError:" \
        ...
        msg = "ERROR: BotoCoreError: There are a wide number of things that can occur for" \
