...
if __name__ == '__main__':
    ...
    # Note: Jum 2026: For a long time now, this has had no value logically and only created
    # the eval_metadata.json file which also had on value. This value will go directly in the
    # final metrics file.
    parser.add_argument(
        '-l',
        '--calibrated',
