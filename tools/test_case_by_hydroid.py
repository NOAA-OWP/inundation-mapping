...
if __name__ == "__main__":
        ...
        if not os.path.exists(test_case_class.fim_dir):
            ...
            for mag in agreement_dict:
                for agree_rast in agreement_dict[mag]:
                    ...
                    & (in_mem_df['TNR']!= "NA") & (in_mem_df['PND']!= "NA") & (in_mem_df['PPV']!= "NA")
                    ...
                    geom_output = hydro_geom_df.merge(in_mem_df, on='HydroID')
    ...
    csv_output.to_file(csv, layer='alpha', driver="GPKG") # encoding='utf-8'
