...
def run_recurr_test(
    fim_run_dir, branch_name, huc_id, magnitude, mask_type="huc", output_dir=None
):
    ...
    print(
        "Running the NWM recurrence intervals for huc_id: "
        + huc_id
        + ", "
        + branch_name
        + "..."
    ...
    for magnitude in magnitude_list:
        ...
        inundation_raster = os.path.join(
            branch_test_case_dir, branch_name + "_inund_extent.tif"
        )
