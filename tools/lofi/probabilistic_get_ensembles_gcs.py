...
def get_gcs_ensembles(
    dts: List[str], hrs: List[str], ens_type: str, feature_ids: List[int], output_path: str, output_name: str
):
    """
    ...
    ----------
    dts : List[str]
        Date time string to get gcs forecast data, needs to be today's date or yesterday's date.
    hrs : List[str]
        Hours to include in getting ensembles from the GCS service.
    ens_type : str
    ...
    if ens_type == "nbm":
        for dt, hour in product(dts, hrs):
            ...
            print("Files that did not run", nofiles)
...
if __name__ == '__main__':
    ...
    dts = ['20250402', '20250403', '20250404', '20250405', '20250406', '20250407']
    hrs = ['0', '6', '12', '18']
    ...
    get_gcs_ensembles(
        ...
        output_name=f"{huc}_ensembles_gcs.nc",
    )
