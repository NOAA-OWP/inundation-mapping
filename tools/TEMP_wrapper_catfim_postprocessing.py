...
fim_version = 'test'
ahps_lid = 'chra2'
extent_grid = '/alaska_catfim/outputs/catfim_BED_test2_flow_based/mapping/19020401/chra2/chra2_record_extent.tif'
magnitude = 'record'
nws_lid_attributes_filename = '/alaska_catfim/outputs/catfim_BED_test2_flow_based/attributes/chra2_attributes.csv'
interval_stage=None,
