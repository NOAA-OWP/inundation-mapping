...
def run_inundation(args):
    ...
    print(os.path.exists(inundation_raster))
...
if __name__ == '__main__':
    ...
    parser.add_argument('-o', '--output-dir',help='The path to a directory to write the outputs. If not used, the inundation_review directory is used by default -> type=str',required=True)
