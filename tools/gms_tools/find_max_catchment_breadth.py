...
def glob_file_paths_for_catchments(hydrofabric_dir):
    ...
    file_pattern_to_glob = os.path.join(hydrofabric_dir,'**','gw_catchments_reaches_filtered_addedAttributes_crosswalked*.gpkg')
...
if __name__ == '__main__':
    ...
    # Parse arguments.
    parser = argparse.ArgumentParser(description='Find the maximum breadth of catchments in given hydrofabric directory')
