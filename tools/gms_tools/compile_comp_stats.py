...
def Compile_comp_stats(hydrofabric_dirs):
    ...
    print(total_per_huc.pivot_table(values='Minutes',index='Model',aggfunc=[np.mean,np.median,np.sum]))
...
if __name__ == '__main__':
    ...
    parser.add_argument('-y','--hydrofabric_dirs', help='Directory path to FIM hydrofabric by processing unit', required=True,nargs='+')
