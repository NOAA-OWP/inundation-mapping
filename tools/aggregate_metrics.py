...
def create_master_metrics_csv():
    ...
    for benchmark_type in ["ble", "ahps"]:
        ...
        if benchmark_type == "ble":
            ...
            for test_case in test_cases_list:
                try:
                    ...
                    previous_versions = os.path.join(
                        test_cases,
                        test_case,
                        "performance_archive",
                        "previous_versions",
        ...
        if benchmark_type == "ahps":
            ...
            test_cases_list = os.listdir(test_cases)
            # AHPS test_ids
            versions_to_aggregate = [
                "fim_1_0_0_nws_1_21_2021",
                "fim_1_0_0_usgs_1_21_2021",
                "fim_2_x_ms_nws_1_21_2021",
                "fim_2_x_ms_usgs_1_21_2021",
                "fim_3_0_0_3_ms_c_nws_1_21_2021",
                "fim_3_0_0_3_ms_c_usgs_1_21_2021",
                "ms_xwalk_fill_missing_cal_nws",
                "ms_xwalk_fill_missing_cal_usgs",
            ]
...
def aggregate_metrics(
    config="DEV", branch="", hucs="", special_string="", outfolder=""
):
    ...
    aggregate_output_dir = os.path.join(
        outfolder, "aggregate_metrics", branch + "_aggregate_metrics" + special_string
    )
    ...
    for magnitude in ["100yr", "500yr", "action", "minor", "moderate", "major"]:
        ...
        if cell_area != 0:
            ...
            print()
            print(
                "Finished aggregating for the '"
                + magnitude
                + "' magnitude. Aggregated metrics over "
                + str(len(huc_path_list) - 1)
                + " test cases."
            )
            print()
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-u",
        "--hucs",
        help="HUC8s to restrict the aggregation.",
        required=False,
        default="",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "-f", "--outfolder", help="output folder", required=True, type=str
    )
