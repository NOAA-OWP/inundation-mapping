...
def copy_folders(folder_name_list, source_dir, target_dir, create_fim_input_list=False):
    '''
...
if __name__ == '__main__':
    ...
    # Sample Usage:
    # python /foss_fim/tools/copy_test_case_folders.py -f /data/inputs/huc_lists/huc_list_for_alpha_tests_20220420.lst -s /outputs/copy_test_synth/ -t /outputs/copy_test_synth_combined -a
    ...
    parser = argparse.ArgumentParser(
        description='Based on the huc list parameter, '
    ...
    parser.add_argument(
        '-s', '--source_dir', help='Source folder to be scanned for unique folders', required=True
    )
    parser.add_argument(
        '-t',
        '--target_dir',
