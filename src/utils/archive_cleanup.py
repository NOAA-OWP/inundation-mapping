...
if __name__ == '__main__':
    ...
    parser.add_argument('archive_cleanup_path', type=str, help='Path to the archived job outputs')
    parser.add_argument('-w', '--additional_whitelist', type=str, help='List of additional files to keep')
