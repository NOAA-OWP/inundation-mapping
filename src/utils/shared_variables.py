...
# -- Data URLs-- #
NHD_URL_PARENT = (
    r"https://prd-tnm.s3.amazonaws.com/StagedProducts/Hydrography/NHDPlusHR/Beta/GDB/"
)
...
os.environ["nhdplus_rasters_dir"] = os.path.join(
    os.environ.get("input_dir"), "nhdplus_rasters"
)
os.environ["nhdplus_vectors_dir"] = os.path.join(
    os.environ.get("input_dir"), "nhdplus_vectors"
)
...
os.environ["nhdplus_aggregate_dir"] = os.path.join(
    os.environ.get("input_dir"), "nhdplus_vectors_aggregate"
)

# File Paths
os.environ["wbd_filename"] = os.path.join(
    os.environ.get("wbd_dir"), "WBD_National.gpkg"
)
os.environ["nwm_streams_orig_filename"] = os.path.join(
    os.environ.get("nwm_dir"), "nwm_flows_original.gpkg"
)
os.environ["nwm_streams_all_filename"] = os.path.join(
    os.environ.get("nwm_dir"), "nwm_flows.gpkg"
)
os.environ["nwm_headwaters_filename"] = os.path.join(
    os.environ.get("nwm_dir"), "nwm_headwaters.gpkg"
)
os.environ["nwm_huc4_intersections_filename"] = os.path.join(
    os.environ.get("nwm_dir"), "nwm_huc4_intersections.gpkg"
)
os.environ["nhd_huc8_intersections_filename"] = os.path.join(
    os.environ.get("nwm_dir"), "nhd_huc8_intersections.gpkg"
)
os.environ["ahps_filename"] = os.path.join(os.environ.get("ahps_dir"), "nws_lid.gpkg")
os.environ["agg_nhd_headwaters_adj_fileName"] = os.path.join(
    os.environ.get("nhdplus_aggregate_dir"), "agg_nhd_headwaters_adj.gpkg"
)
os.environ["agg_nhd_streams_adj_fileName"] = os.path.join(
    os.environ.get("nhdplus_aggregate_dir"), "agg_nhd_streams_adj.gpkg"
)
os.environ["nwm_catchments_orig_filename"] = os.path.join(
    os.environ.get("nwm_dir"), "nwm_catchments_original.gpkg"
)
os.environ["nwm_catchments_all_filename"] = os.path.join(
    os.environ.get("nwm_dir"), "nwm_catchments.gpkg"
)
