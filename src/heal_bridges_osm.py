...
def process_bridges_in_huc(source_hand_raster, bridge_file, output_bridge_lines_raster_file, output_final_burned_file, resolution):
    """
    Process:
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        '-s',
        '--bridge_file',
        help='REQUIRED: A gpkg that contains the bridges vectors',
        required=True,
    )
