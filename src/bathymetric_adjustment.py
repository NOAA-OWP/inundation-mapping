...
fim_dir = "/efs-drives/fim-dev-efs/fim-home/heidi.safa/aib_bathy_adjustment/data/fim_4_5_2_0/"
huc = "07130003" # 07130003, 05020005, 05030101

bathy_file = "/efs-drives/fim-dev-efs/fim-home/bathymetry_processing/bathymetry_illinois.gpkg"
bathy_file = "/efs-drives/fim-dev-efs/fim-home/heidi.safa/aib_bathy_adjustment/data/bathy_data/bathymetry_adjustment_data.gpkg"
...
def plot_ehydro_aib_original_srcs(fim_dir, huc):
    ...
    for src_eh in csv_files_ehydro:
        ...
        if branch != "0": 
            ...
            else: print("No plot for branch O")


def make_copy_original_src(fim_dir, huc):
...
make_copy_original_src(fim_dir, huc)
correct_rating_for_ehydro_bathymetry(fim_dir, huc, bathy_file, verbose)
correct_rating_for_ai_based_bathymetry(path_aib_bathy_parquet, fim_dir, huc)
plot_ehydro_aib_original_srcs(fim_dir, huc)
