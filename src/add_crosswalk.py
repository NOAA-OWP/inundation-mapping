...
def add_crosswalk(
    ...
    sword_slope = input_src_base['SLOPE_IRIS_SWORD'].where(sword_mask).round(17)
    # hfab_slope = input_src_base['SLOPE_HFAB'].where(hfab_mask)

    # Assign SLOPE values with priority: IRIS_SWORD then RISE_RUN
    input_src_base['SLOPE'] = sword_slope.combine_first(input_src_base['SLOPE_RISE_RUN']).round(17)
