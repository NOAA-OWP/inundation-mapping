...
def generate_branch_list(stream_network_dissolved, branch_id_attribute, output_branch_list_file):
    """
    Processing:
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-b",
        "--branch-id-attribute",
        help="Branch ID attribute to use in dissolved stream network",
        required=True,
    )
