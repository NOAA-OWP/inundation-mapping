...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '-s',
        '--subset-vectors',
        help='Vector file names to query by attribute',
        required=False,
        default=None,
        nargs="+",
    )
    parser.add_argument(
        '-o',
        '--out-files',
        help='Vector filenames to write to after query',
        required=False,
        default=None,
        nargs="+",
    )
    ...
    attributes_vector_file, branch_ids, attribute, subset_vectors, out_files, verbose = (
        args["vector_attributes"],
        args["branch_ids"],
        args["attribute_id"],
        args["subset_vectors"],
        args["out_files"],
