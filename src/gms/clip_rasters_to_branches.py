...
if __name__ == '__main__':
    ...
    parser.add_argument('-i','--branch-id-attribute', help='Branch ID attribute', required=True,default=None)
    ...
    stream_polygons_file, branch_id, branch_id_attribute, rasters, clipped_rasters, verbose = args["branches"], args["branch_id"],args["branch_id_attribute"],args["rasters"] , args["clipped_rasters"], args["verbose"]
