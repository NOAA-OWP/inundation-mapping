...
%% Abstract
\input{sections/abstract_plainTextSummary}
...
More information on code availability, usage, and data retrieval for OWP FIM is available at https://github.com/NOAA-OWP/cahaba.
Thanks to the Earth and Space Science Informatics Partnership (ESIP) for storing data from this study for public use and dissemination helping to provide transparent datasets for further collaboration with the research community.
