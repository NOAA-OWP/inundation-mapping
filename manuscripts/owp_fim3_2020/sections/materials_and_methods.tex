...
Small reaches can lead to unrealistic variances in channel geometries while too large reaches can lead to grouping too much geometry variance into one parametrized unit.
...
The reach averaged method has been evaluated to ...
The reach averaged parameters are sampled from the thalweg conditioned AGREE DEM using TauDEM's catchhydrogeo utility.

The Manning's n values are tuned ... 
