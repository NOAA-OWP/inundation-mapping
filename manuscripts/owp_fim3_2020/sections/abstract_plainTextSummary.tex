...
Additional modeling capabilities are required to convert these 1-D discharge forecasts into 2-D inundation extents used for forecasting purposes to protect life and property.
The Office of Water Prediction Flood Inundation Mapping Version 3.0 `Cahaba' (OWP-FIM V3.0) was developed to provide these inundation mapping services based on the latest advancements in methodology and data sources available. 
