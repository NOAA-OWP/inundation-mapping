...
class test_clip_vectors_to_wbd(unittest.TestCase):
    ...
    def test_subset_vector_layers_success(self):
        ...
        src.subset_vector_layers(hucCode = params["hucCode"],
                ...
                nhd_streams_filename = params["nhd_streams_filename"],
                nwm_lakes_filename = params["nwm_lakes_filename"],
                nld_lines_filename = params["nld_lines_filename"],
                nwm_catchments_filename = params["nwm_catchments_filename"],
                nhd_headwaters_filename = params["nhd_headwaters_filename"],
                landsea_filename = params["landsea_filename"],
                levee_protected_areas_filename = params["levee_protected_areas_filename"],
                wbd_filename = params["wbd_filename"],
                wbd_buffer_filename = params["wbd_buffer_filename"],
                subset_nhd_streams_filename = params["subset_nhd_streams_filename"],
                subset_nld_lines_filename = params["subset_nld_lines_filename"],
                subset_nwm_lakes_filename = params["subset_nwm_lakes_filename"],
                subset_nwm_catchments_filename = params["subset_nwm_catchments_filename"],
                subset_nhd_headwaters_filename = params["subset_nhd_headwaters_filename"],
                subset_nwm_streams_filename = params["subset_nwm_streams_filename"],
                subset_landsea_filename = params["subset_landsea_filename"],
                subset_levee_protected_areas_filename = params["subset_levee_protected_areas_filename"],
