...
if __name__ == '__main__':
    ...
    parser.add_argument('-l','--huc8-list',help='A list of HUC8s to synthesize.',required=False, default="")
    parser.add_argument('-o','--output-folder',help='The directory where synthesis outputs will be written.',required=False, default="")
